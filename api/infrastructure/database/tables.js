...
class Tables {
  ...
  createTableMoviasCarTracking() {
    ...
    totalKmPLitro DOUBLE, totalLitroPhora DOUBLE, totalKmPPorcente DOUBLE, totalPorcentePhora DOUBLE, startDate DATE, timeReport int, odometerStart DOUBLE, odometerEnd DOUBLE, 
    maxSpeedOverallValue int, maxRpmValue int, distanceTraveled DOUBLE, timingsIdleTime int, timingsOnTime int, timingsTripTime int, timingsOffTime int, timingsOverSpeed int,
    maxFuelEconomyValue int, averagesSpeed int, averagesRpm int, timeTotalViagemSeg int, endDate DATE, PRIMARY KEY (id))`
